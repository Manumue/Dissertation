...
%\newpage
%\begin{minipage}[t]{.5\textwidth}
\captionof{table}[Reaktionsansatz für die cDNA-Synthese]{Reaktionsansatz cDNA-Synthese}
\begin{tabular}{
p{.3\textwidth}
p{.05\textwidth}
S[table-format=1.0,table-comparator=true,table-space-text-post={***********}]
